                ...
                <div class="card-body">
                    <form action="{{ route('store.product') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="product_name" id="basic-default-fullname"
                                placeholder="" required />
                        </div>
                        <div class="row">
                            <div class="col mb-3">
                                <label class="form-label" for="basic-default-company">Price</label>
                                <input type="text" class="form-control" name="price" id="basic-default-company"
                                    placeholder="ACME Inc." required />
                            </div>
                            <div class="col mb-3">
                                <label class="form-label" for="basic-default-company">Old Price</label>
                                <input type="text" class="form-control" name="old_price" id="basic-default-company"
                                    placeholder="ACME Inc." required />
                            </div>
                        </div>
                        <div class="row">
                          <div class="col mb-3">
                              ...
                              <input type="number" class="form-control" name="ratting" min="0" max="5" id="basic-default-company"
                                  placeholder="ACME Inc." required />
                          </div>
                          <div class="col mb-3">
                      ...
                      <script>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="quantity" class="form-control phone-mask" required />
                        ...
                        <div class="mb-3">
                            ...
                            <textarea id="basic-default-message" name="description" class="form-control" placeholder="Product Description"></textarea>
                        </div>
