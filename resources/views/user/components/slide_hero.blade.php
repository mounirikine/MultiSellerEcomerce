<style>
    ...
    .hero_title {
        ...
        font-weight: 600;
        text-align: center;
        color: #161474; /* Adjust the color to your preference */
        margin-bottom: 10px;
    }
...
<div class="col-lg-12 col-md-8">
    <div class="slider-area slider-area-3 pt-sm-30 pt-xs-30 pb-xs-30">
        <div class="container_hero">
            <div class="content">
                <h1 class="hero_title">
                    Discover the Best <span class="chnage">Shopping</span> Experience
                </h1>
                <p class="subtitle">
                    Explore a curated selection of your favorite products with us.
                </p>
                <?php if (!auth()->check()): ?>
